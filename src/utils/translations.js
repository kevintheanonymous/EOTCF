export const translations = {
  en: {
    ...
    aiInsightPrompt: 'Click the button below to generate an AI analysis of your current financial standing.',
    ledger: 'Ledger',
    ...
    emailChangeNote: 'To change your email, please contact an administrator.',
  ...
  fr: {
    ...
    aiInsightPrompt: 'Cliquez sur le bouton ci-dessous pour générer une analyse IA de votre situation financière actuelle.',
    ledger: 'Grand livre',
    ...
    success: 'Succès',
    close: 'Fermer',
    welcomeBack: 'Bon retour ! Veuillez entrer vos informations.',
    manageProfile: 'Gérez vos informations personnelles',
    generateInsight: 'Générer une analyse',
    ...
    emailChangeNote: 'Pour changer votre e-mail, veuillez contacter un administrateur.',
    selectCategory: 'Sélectionnez une catégorie...',
    select: 'Sélectionner...',
    
    // Security & Rate Limiting
    accountLocked: 'Trop de tentatives échouées. Veuillez réessayer dans {minutes} minutes.',
    attemptsRemaining: 'tentatives restantes',
    invalidEmail: 'Veuillez entrer une adresse e-mail valide',
    passwordWeak: 'Mot de passe faible',
    passwordMedium: 'Force moyenne',
    passwordStrong: 'Mot de passe fort',
    passwordsMatch: 'Les mots de passe correspondent',
    offlineMode: 'Vous êtes hors ligne. Certaines fonctionnalités peuvent être limitées.',
  ...
  am: {
    ...
    aiInsightPrompt: 'የአሁኑ የጌንዘብ ሁኔታዎን AI ትንታኔ ለማገኗት ከዚህ በታች ያለውን አንቆጭ ይጫኑ።',
    ledger: 'የግብይት መዝገብ',
    ...
    manageProfile: 'የግል መረጃዎን ያቀናብሩ',
    generateInsight: 'ትንታኔ ይፍጠሩ',
    analyzing: 'በመተንተን ላይ...',
    forgotPassword: 'የይለፍ ቃል ረሱ?',
    resetPassword: 'የይለፍ ቃል ዳግም ይቀናሉ',
    resetPasswordDesc: 'የኢሜይል አድራሻዎን ያስገቡ እና የይለፍ ቃል ዳግም ለማዘጋጀት ማገናኛ እንልክልዎታለን።',
    sendLink: 'ማገናኛ ይላኩ',
    sending: 'በመላክ ላይ...',
    passwordResetSent: 'የይለፍ ቃል ዳግም ማዘጋጃ ኢሜይል ተልኳል! የገቢ ሳጥንዎን ይፈትሹ።',
    noAccount: 'መለያ የለዎትም?',
    haveAccount: 'አስቀድሞ መለያ አለዎት?',
    editProfile: 'መገለጫ ያርሙ',
    saveChanges: 'ለውጦችን ያስቀምጡ',
    emailChangeNote: 'ኢሜይልዎን ለመለወጥ እባክዎ አስተዳዳሪን ያናግሩ።',
    selectCategory: 'ምድብ ይምረጡ...',
    select: 'ይምረጡ...',
    
    // Security & Rate Limiting
    accountLocked: 'በጣም ብዙ ያልተሳኩ ሙከራዎች። እባክዎ በ{minutes} ደቂቃ ውስጥ እንደገና ይሞክሩ።',
    attemptsRemaining: 'ሙከራዎች ቀርተዋል',
    invalidEmail: 'እባክዎ ትክክለኛ የኢሜይል አድራሻ ያስገቡ',
    passwordWeak: 'ደካማ የይለፍ ቃል',
    passwordMedium: 'መካከለኛ ጥንካሬ',
    passwordStrong: 'ጠንካራ የይለፍ ቃል',
    passwordsMatch: 'የይለፍ ቃሎች ይዛመዳሉ',
    offlineMode: 'ከመስመር ውጭ ነዎት። አንዳንድ ባህሪያት ሊገደቡ ይችላሉ።',
    emailVerificationSent: 'የማረጋገጫ ኢሜይል ተልኳል! የገቢ ሳጥንዎን ይፈትሹ።',
