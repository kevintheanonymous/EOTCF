...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Stats Grid - NO EMOJIS, PROFESSIONAL SVGS */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
        ...
        <StatCard 
            ...
            colorClass={stats.net >= 0 ? "text-emerald-600 bg-emerald-600" : "text-red-600 bg-red-600"} 
            icon={<svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" /></svg>} 
        />
        <StatCard 
